...
# dev from 02 - 19 - 2020 to 05 - 12 - 2020
# developpé du 19/02/2020 au 12/05/2020
# version 2.0 (release)
...
def calcul():
    ...
    if int(year) < 1583:
        ...
        # resultat
        result_label_sunday = Label(frame1, text=("Pour l'année " + str(year) + ", le dimanche de pâques tombe le "
                                                  + str(j) + " " + mstring + "."), font=('Tahoma', 10), bg='#87CEEB')
        result_label_monday = Label(frame1, text=("Le lundi de pâques tombe donc le " + str(lundi) + " " + mlstring +
                                                  "."),
                                    font=('Tahoma', 10), bg='#87CEEB')
        result_label_sunday.pack_forget()
        result_label_monday.pack_forget()
        # year_entry.pack_forget()
        # get_year_button.pack_forget()
